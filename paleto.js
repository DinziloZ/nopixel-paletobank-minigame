class NoPixel_Fleeca{
    ...
    types = [
        ...
        // Upper text - Color
        {'type': 'text_color','text': 'color text'},
    ...
    create(){
        ...
        let solution1 = minigame['groups'][quiz_numbers[index1]][types[0]['type']];
        let solution2 = minigame['groups'][quiz_numbers[index2]][types[1]['type']];
        solution1 = solution1.replace(/\d/,'');
        solution2 = solution2.replace(/\d/,'');

        minigame['quiz1'] = {
            'pos': quiz_numbers[index1],
            'type': types[0],
            'solution': solution1
        };

        minigame['quiz2'] = {
            'pos': quiz_numbers[index2],
            'type': types[1],
            'solution': solution2
        };
...
// Reset lại streak sau khi nhấn nút Again
